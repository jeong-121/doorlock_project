// -----------------------------------------------------------------------------
// fsm_module.v
// Digital doorlock main FSM with password logic and 10-second auto-lock support.
//
// 담당 구현 범위
...
// Default auto-lock: 10 seconds = 10,000 ticks.
// -----------------------------------------------------------------------------
module fsm_module #(
        ...
        if (rst) begin
            ...
            case (state)
                ...
                UNLOCK: begin
                    ...
                    // Auto-lock has priority after timeout.
                ...
                CHANGE: begin
                    ...
                    // Password change: save new 4-digit BCD password and re-lock.
                    if (enter_pulse) begin
